                        ...
                        <div class="post-wrapper clearfix border-bottom">
                            <div class="hotel-wrapper">
                                <div class="post-media">
                                    <a href="hotel-single.html"><img src="images/destination/tanjung_puting_borneo/D246_56_523_1200.jpg" alt="" class="img-responsive"></a>
                                </div><!-- end media -->
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="post-wrapper clearfix border-bottom">
                            <div class="hotel-wrapper">
                                ...
                                <div class="post-title clearfix">
                                    <div class="pull-left">
                                        <h5><a href="hotel-single.html" title="">PRINCIPE FORTE DEI MARMI</a></h5>
                                    </div><!-- end left -->
                                    <div class="pull-right">
                                        <h6>$225</h6>
                                    </div><!-- end left -->
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="post-wrapper clearfix border-bottom">
                            <div class="hotel-wrapper">
                                ...
                                <div class="post-title clearfix">
                                    <div class="pull-left">
                                        <h5><a href="hotel-single.html" title="">PRINCIPE HOTEL DA MITA</a></h5>
                                    </div><!-- end left -->
                                    <div class="pull-right">
                                        <h6>$225</h6>
                                    </div><!-- end left -->
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="post-wrapper clearfix border-bottom">
                            <div class="hotel-wrapper">
                                ...
                                <div class="post-title clearfix">
                                    <div class="pull-left">
                                        <h5><a href="hotel-single.html" title="">PRINCE IPE HOTEL DA MITA</a></h5>
                                    </div><!-- end left -->
                                    <div class="pull-right">
                                        <h6>$225</h6>
                                    </div><!-- end left -->
